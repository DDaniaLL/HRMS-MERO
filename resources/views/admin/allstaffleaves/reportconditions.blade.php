                              ...
                              <div class="col-12 col-lg-10 col-xl-10">
                                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                                  ...
                                  <form class="form-outline" autocomplete="off" action="{{ route('admin.leaves.pdfshow') }}" method="POST" target="__blank">
                                      ...
                                      <div class="row justify-content-between text-left">
                                        <div class="form-group {{ $errors->has('numberofdays') ? ' has-danger' : '' }} col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-1">{{__('leavesPDF.numberofdays')}}</label>
                                            <input class="form-control form-outline {{ $errors->has('numberofdays') ? ' is-invalid' : '' }}" type="text" value="{{ old('numberofdays') }}" name="numberofdays" id="numberofdays" placeholder="" >
                                            @if ($errors->has('numberofdays'))
                                                <span id="numberofdays-error" class="error text-danger" for="input-numberofdays">{{ $errors->first('numberofdays') }}</span>
                                               @endif
                                        </div>
